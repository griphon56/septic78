<div class="container-fluid contact">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-5">
        <h3 class="section-item">Главный офис</h3>
        <div class="section-desc">
          <p>195027</p>
          <p>г. Санкт-Петербург</p>
          <p>пр. Энергетиков, д.10</p>
        </div>
        <div class="section-desc">
          <p>+7 (812) 413-92-98</p>
    ...
    <div class="row">
      <div class="col-md-12">
        <h3 class="section-item">Филилалы</h3>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6">
        <div class="section-desc">
          <p>443099</p>
          <p>г. Самара</p>
          <p>ул. Водников, д. 60, офис 814</p>
        </div>
        <div class="section-desc">
          <p>620078</p>
          <p>г. Екатеринбург</p>
          <p>ул. Вишнёвая, д. 35, офис 512</p>
        </div>
        <div class="section-desc">
          <p>630007</p>
          <p>г. Новосибирск</p>
          <p>ул. Октябрьская магистраль, д. 4, офис 211</p>
        </div>
      </div>
      <div class="col-md-6 contact-background">
        <div class="section-desc">
          <p>680014</p>
          <p>г. Хабаровск</p>
          <p>ул. Восточное шоссе, д. 41, офис 206</p>
        </div>
        <div class="section-desc">
          <p>344006</p>
          <p>г. Ростов-на-Дону</p>
          <p>пр-т Чехова, д. 34</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row document-bg-img">
      <div class="col-md-5">
        <div class="document-img">
          <img src="<?=VIEW?>img/contactView/1-page-001.jpg" alt="">
        </div>
      </div>
      <div class="col-md-2"></div>
      <div class="col-md-5">
        <div class="document-img">
          <img src="<?=VIEW?>img/contactView/2-page-001.jpg" alt="">
        </div>
      </div>
    </div>
  </div>
